...
mamba install -v -c conda-forge -y "numpy>=1.26.0,<2.0" "pandas>=2.2.0" "matplotlib>=3.8.0" "seaborn>=0.13.0" "plotly>=5.18.0" "biopython>=1.80" "scikit-learn>=1.4.0" "click>=8.1.0" "tqdm>=4.66.0" "pyyaml>=6.0.0" "loguru>=0.7.0" "psutil>=5.9.0" 2>&1 | tee /tmp/mamba_install.log
if [ ${PIPESTATUS[0]} -eq 0 ]; then
    ...
    if echo "$MAMBA_ERROR" | grep -q "json\|cache\|corrupted"; then
        ...
        conda install -v -c conda-forge -y "numpy>=1.26.0,<2.0" "pandas>=2.2.0" "matplotlib>=3.8.0" "seaborn>=0.13.0" "plotly>=5.18.0" "biopython>=1.80" "scikit-learn>=1.4.0" "click>=8.1.0" "tqdm>=4.66.0" "pyyaml>=6.0.0" "loguru>=0.7.0" "psutil>=5.9.0" || {
            ...
            conda install -v -c conda-forge -y "numpy>=1.26.0,<2.0" "pandas>=2.2.0" "matplotlib>=3.8.0" "seaborn>=0.13.0" || true
        ...
        mamba install -v -c conda-forge -y "numpy>=1.26.0,<2.0" "pandas>=2.2.0" "matplotlib>=3.8.0" "seaborn>=0.13.0" || true
